...
// import "../styles/signuppage-style.css"; // We will inject custom styles instead
...
function AdminSignupPage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            setTimeout(() => navigate("/admin-login"), 1500); // Redirect to Admin Login
        } catch (err) {
    ...
    const styles = {
        ...
        card: {
            ...
            width: "100%",
            maxWidth: "600px",
            borderTop: "5px solid #FFC300" // Admin Gold Border
        },
        header: {
            textAlign: "center",
            marginBottom: "30px"
        ...
        button: {
            width: "100%",
            padding: "14px",
            backgroundColor: "#333", // Admin Dark Button
            color: "#FFC300",         // Admin Gold Text
            border: "none",
            borderRadius: "8px",
            fontSize: "16px",
            fontWeight: "700",
            ...
            <div style={styles.mainContainer}>
                <div style={styles.card}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {/* ROLE SELECTION REMOVED - AUTOMATICALLY ADMIN */}
                        ...
                        <p style={{ textAlign: "center", marginTop: "20px", color: "#666" }}>
                            Have an account? <Link to="/admin-login" style={{ color: "#FFC300", fontWeight: "bold", textDecoration: "none" }}>Log in here</Link>
                        </p>
                    </form>
                </div>
            </div>
